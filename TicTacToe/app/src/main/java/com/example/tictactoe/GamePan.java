    ...
    public void onClick(View v) {
        ...
        if(checkWinner()){
            if (!activePlayer){
                ...
                if(!(nameOneisGuest || nameTwoisGuest)){
                    int id2 = db.getId(playerTwoName.getText().toString());
                    Log.d("id",""+id2);

                    int score2 = db.getPlayer(id2).getScore() + playerTwoScoreCount;
                    Log.d("score2",""+score2);
                    Player player2 = new Player(id2,playerTwoName.getText().toString(),score2);
