...
public class MainActivity extends AppCompatActivity{
    ...
    TextView tvPlayer2;
    DBHelper db;
    Button buttonSignInPlayer1,buttonSignInPlayer2,buttonIsReady1,buttonIsReady2, buttonPlay, btnPLayAsGuest1,btnPlayAsGuest2;
